...
return [
    ...
    ['GET',  '/admin/central-tecnica/base-conhecimento/backlog', [\App\Controllers\Admin\TechnicalCenterController::class, 'backlog'], ['auth', 'capability:docs']],
    ['GET',  '/admin/central-tecnica/base-conhecimento/documentacao', [\App\Controllers\Admin\TechnicalCenterController::class, 'documentacao'], ['auth', 'capability:docs']],
    ['GET',  '/admin/central-tecnica/base-conhecimento/regras', [\App\Controllers\Admin\TechnicalCenterController::class, 'regras'], ['auth', 'capability:docs']],
    ...
    ['GET',  '/admin/central-operacional-v2/backup-sistemico/{backup_secao}', [\App\Controllers\Admin\OperationsV2Controller::class, 'backupSistemico'], ['auth', 'capability:operations']],
    ...
    ['GET',  '/admin/central-operacional-v2/backup-editorial/{editorial_secao}', [\App\Controllers\Admin\OperationsV2Controller::class, 'backupEditorial'], ['auth', 'capability:operations']],
    ...
    ['GET',  '/admin/central-operacional-v2/backup-em-nuvem/{cloud_secao}', [\App\Controllers\Admin\OperationsV2Controller::class, 'backupEmNuvem'], ['auth', 'capability:operations']],
    ...
    ['GET',  '/admin/central-operacional-v2/hostinger-api', [\App\Controllers\Admin\HostingerApiController::class, 'index'], ['auth', 'capability:operations']],
    ['GET',  '/admin/central-operacional-v2/seo-tecnico/{monitor_secao}', [\App\Controllers\Admin\OperationsV2Controller::class, 'seoTecnico'], ['auth', 'capability:operations']],
