...
return [
    ...
    ['GET',  '/admin/usuarios',          [\App\Controllers\Admin\UsuariosController::class, 'index'], ['auth', 'capability:multi_env_users']],
    ['GET',  '/admin/criar-usuario',     [\App\Controllers\Admin\UsuariosController::class, 'create'], ['auth', 'capability:multi_env_users']],
    ['POST', '/admin/criar-usuario',     [\App\Controllers\Admin\UsuariosController::class, 'store'], ['auth', 'capability:multi_env_users']],
    ['GET',  '/admin/editar-usuario',    [\App\Controllers\Admin\UsuariosController::class, 'edit'], ['auth', 'capability:multi_env_users']],
    ['POST', '/admin/editar-usuario',    [\App\Controllers\Admin\UsuariosController::class, 'update'], ['auth', 'capability:multi_env_users']],
    ['POST', '/admin/usuarios/status',   [\App\Controllers\Admin\UsuariosController::class, 'updateStatus'], ['auth', 'capability:multi_env_users']],
    ['GET',  '/admin/excluir-usuario',   [\App\Controllers\Admin\UsuariosController::class, 'deleteConfirm'], ['auth', 'capability:multi_env_users']],
    ['POST', '/admin/excluir-usuario',   [\App\Controllers\Admin\UsuariosController::class, 'destroy'], ['auth', 'capability:multi_env_users']],
    ['GET',  '/admin/home-e-menus',        [\App\Controllers\Admin\HomeMenusController::class, 'index'], ['auth', 'capability:multi_env_menus']],
    ['POST', '/admin/home-e-menus',        [\App\Controllers\Admin\HomeMenusController::class, 'update'], ['auth', 'capability:multi_env_menus']],
