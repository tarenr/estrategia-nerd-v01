...
<div class="max-w-7xl mx-auto px-4 py-6 space-y-6">
  <div class="admin-page-header">
    <div class="admin-page-heading">
      ...
      <div class="admin-page-subtitle">Diagnostico tecnico do painel, ambiente PHP, banco e estrutura de arquivos antes da publicacao.</div>
    </div>
  ...
  <section class="admin-panel">
    <div class="flex items-center justify-between gap-4 flex-wrap mb-5">
      <div>
        ...
        <div class="text-xs text-slate-400 mt-1">Leitura direta do ambiente atual do projeto.</div>
      </div>
