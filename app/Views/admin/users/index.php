...
<div class="max-w-7xl mx-auto px-4 py-6 space-y-6">
  ...
  <?php View::component('admin/users/table', ['items' => $items ?? [], 'filters' => $filters, 'sort' => $sort, 'dir' => $dir, 'pagination' => $pagination, 'current_user_id' => $currentUserId, 'active_admins_total' => $activeAdminsTotal]); ?>
