...
$cards = [
    [
        ...
        'support' => [
            ...
            ['label' => 'No menu', 'value' => $fmtNumber((int) ($summary['menu'] ?? 0))],
        ],
    ],
    [
        'icon' => 'fa-check-double',
        'label' => 'Indexacao e menu',
        'hint' => 'Controle tecnico da exposicao publica.',
        'value' => $fmtNumber((int) ($summary['indexaveis'] ?? 0)),
        'color' => '#34d399',
        'iconBg' => 'linear-gradient(135deg, rgba(34,197,94,.88), rgba(6,182,212,.88))',
        'support' => [
            ['label' => 'Noindex', 'value' => $fmtNumber((int) ($summary['noindex'] ?? 0))],
            ['label' => 'Fora do menu', 'value' => $fmtNumber((int) ($summary['fora_menu'] ?? 0)), 'accent' => '#34d399'],
        ],
    ],
    [
        'icon' => 'fa-newspaper',
