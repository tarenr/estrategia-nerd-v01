...
<section class="admin-panel post-editor-panel">
  <div class="flex items-center justify-between gap-4 flex-wrap mb-4">
    ...
    <div class="flex items-center gap-2 text-xs text-slate-400 flex-wrap justify-end">
      <span id="wordCount">0 palavras</span>
      <button type="button" id="editor-upload-trigger" class="admin-btn admin-btn-secondary" onclick="return window.enviarImagemDoEditor ? (window.enviarImagemDoEditor(), false) : false;">Enviar imagem</button>
      <button type="button" id="editor-url-trigger" class="admin-btn admin-btn-secondary" onclick="return window.inserirImagem ? (window.inserirImagem(), false) : false;">URL da imagem</button>
      <button type="button" id="editor-video-trigger" class="admin-btn admin-btn-secondary" onclick="return window.inserirVideo ? (window.inserirVideo(), false) : false;">Inserir video</button>
  ...
  <div id="panel-visual" class="editor-panel">
    <div class="editor-sticky-shell">
      <div class="editor-toolbar mb-0 flex flex-wrap gap-2">
        ...
        <button type="button" class="editor-btn" title="Cita̤̣o" onclick="aplicarCitacao()"><i class="fa-solid fa-quote-left"></i></button>
        ...
        <button type="button" class="editor-btn" title="Limpar formata̤̣o" onclick="limparFormatacao()"><i class="fa-solid fa-eraser"></i></button>
      </div>
    </div>
  ...
  <div id="panel-gerador" class="editor-panel hidden space-y-4">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div class="md:col-span-2">
        ...
        <p class="mt-3 text-xs text-slate-400">No comparativo, use <strong class="text-slate-200">Adicionar linha</strong> para montar cada criterio da tabela em campos separados.</p>
      </div>
    </div>
    ...
    <div class="flex flex-wrap gap-2 items-center">
      ...
      <label for="gerador-apply-mode" class="text-xs font-bold text-slate-300">Modo</label>
